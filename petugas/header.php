    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="../assets/img/logo/logo.png" alt="logo" /></a>
                <strong><a href="index.html"><img src="../assets/img/logo/logosn.png" alt="logosn" /></a></strong>
            </div>
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="#" class="nav-link"> Arsip Digital</a></li>
                                            </ul>
                                        </div>
                                    </div>
