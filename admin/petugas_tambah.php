                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu" style="padding-top: 0px">
                                ...
                                <li><a href="petugas.php">Petugas</a> <span class="bread-slash">/</span></li>
    ...
    <div class="row">
        <div class="col-lg-7 col-md-8 col-sm-12 col-xs-12">
            ...
            <div class="alert alert-info">
                <i class="fa fa-info-circle alert-icon"></i> Silahkan isi semua informasi yang diperlukan untuk menambahkan petugas baru ke sistem.
            </div>
            
            <!-- Form Panel -->
            <div class="form-panel panel">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-user-plus"></i> Form Tambah Petugas</h3>
                </div>
                <div class="panel-body">
                    <div class="pull-right">            
                        <a href="petugas.php" class="btn btn-back">
                    ...
                    <form method="post" action="petugas_aksi.php" enctype="multipart/form-data" id="formTambahPetugas">
            ...
            <div class="form-panel panel">
                ...
                <div class="panel-body">
                    <div class="alert alert-success">
                        <i class="fa fa-lightbulb-o alert-icon"></i> <strong>Tips!</strong> Petugas yang ditambahkan akan langsung dapat mengakses sistem.
                    </div>
                    ...
                    <h4><i class="fa fa-shield"></i> Hak Akses</h4>
                    <p>Petugas memiliki akses untuk:</p>
                    <ul>
                        <li>Mengelola arsip</li>
                        <li>Melihat daftar user</li>
